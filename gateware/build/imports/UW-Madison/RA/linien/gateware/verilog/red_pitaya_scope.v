 ...
 * GENERAL DESCRIPTION:
 *
 * This is simple data aquisition module, primerly used for oscilloscope
...
module red_pitaya_scope (
    ...
    if (adc_rstn_i == 1'b0) begin
      ...
      case (set_dec & {32{set_avg_en}})
        32'h0: begin
          ...
          adc_a_q_dat <= adc_a_q_filt_out;
          adc_b_q_dat <= adc_b_q_filt_out;
        end
        32'h1: begin
          adc_a_dat   <= adc_a_sum[15+0 : 0];
          adc_b_dat   <= adc_b_sum[15+0 : 0];
          adc_a_q_dat <= adc_a_q_sum[15+0 : 0];
          adc_b_q_dat <= adc_b_q_sum[15+0 : 0];
        end
        32'h2: begin
          adc_a_dat   <= adc_a_sum[15+1 : 1];
          adc_b_dat   <= adc_b_sum[15+1 : 1];
          adc_a_q_dat <= adc_a_q_sum[15+1 : 1];
          adc_b_q_dat <= adc_b_q_sum[15+1 : 1];
        end
        32'h4: begin
          adc_a_dat   <= adc_a_sum[15+2 : 2];
          adc_b_dat   <= adc_b_sum[15+2 : 2];
          adc_a_q_dat <= adc_a_q_sum[15+2 : 2];
          adc_b_q_dat <= adc_b_q_sum[15+2 : 2];
        end
        32'h8: begin
          adc_a_dat   <= adc_a_sum[15+3 : 3];
          adc_b_dat   <= adc_b_sum[15+3 : 3];
          adc_a_q_dat <= adc_a_q_sum[15+3 : 3];
          adc_b_q_dat <= adc_b_q_sum[15+3 : 3];
        end
        32'h10: begin
          adc_a_dat   <= adc_a_sum[15+4 : 4];
          adc_b_dat   <= adc_b_sum[15+4 : 4];
          adc_a_q_dat <= adc_a_q_sum[15+4 : 4];
          adc_b_q_dat <= adc_b_q_sum[15+4 : 4];
        end
        32'h20: begin
          adc_a_dat   <= adc_a_sum[15+5 : 5];
          adc_b_dat   <= adc_b_sum[15+5 : 5];
          adc_a_q_dat <= adc_a_q_sum[15+5 : 5];
          adc_b_q_dat <= adc_b_q_sum[15+5 : 5];
        end
        32'h40: begin
          adc_a_dat   <= adc_a_sum[15+6 : 6];
          adc_b_dat   <= adc_b_sum[15+6 : 6];
          adc_a_q_dat <= adc_a_q_sum[15+6 : 6];
          adc_b_q_dat <= adc_b_q_sum[15+6 : 6];
        end
        32'h80: begin
          adc_a_dat   <= adc_a_sum[15+7 : 7];
          adc_b_dat   <= adc_b_sum[15+7 : 7];
          adc_a_q_dat <= adc_a_q_sum[15+7 : 7];
          adc_b_q_dat <= adc_b_q_sum[15+7 : 7];
        end
        32'h100: begin
          adc_a_dat   <= adc_a_sum[15+8 : 8];
          adc_b_dat   <= adc_b_sum[15+8 : 8];
          adc_a_q_dat <= adc_a_q_sum[15+8 : 8];
          adc_b_q_dat <= adc_b_q_sum[15+8 : 8];
        end
        32'h200: begin
          adc_a_dat   <= adc_a_sum[15+9 : 9];
          adc_b_dat   <= adc_b_sum[15+9 : 9];
          adc_a_q_dat <= adc_a_q_sum[15+9 : 9];
          adc_b_q_dat <= adc_b_q_sum[15+9 : 9];
        end
        32'h400: begin
          adc_a_dat   <= adc_a_sum[15+10:10];
          adc_b_dat   <= adc_b_sum[15+10:10];
          adc_a_q_dat <= adc_a_q_sum[15+10:10];
          adc_b_q_dat <= adc_b_q_sum[15+10:10];
        end
        32'h800: begin
          adc_a_dat   <= adc_a_sum[15+11:11];
          adc_b_dat   <= adc_b_sum[15+11:11];
          adc_a_q_dat <= adc_a_q_sum[15+11:11];
          adc_b_q_dat <= adc_b_q_sum[15+11:11];
        end
        32'h1000: begin
          adc_a_dat   <= adc_a_sum[15+12:12];
          adc_b_dat   <= adc_b_sum[15+12:12];
          adc_a_q_dat <= adc_a_q_sum[15+12:12];
          adc_b_q_dat <= adc_b_q_sum[15+12:12];
        end
        32'h2000: begin
          adc_a_dat   <= adc_a_sum[15+13:13];
          adc_b_dat   <= adc_b_sum[15+13:13];
          adc_a_q_dat <= adc_a_q_sum[15+13:13];
          adc_b_q_dat <= adc_b_q_sum[15+13:13];
        end
        32'h4000: begin
          adc_a_dat   <= adc_a_sum[15+14:14];
          adc_b_dat   <= adc_b_sum[15+14:14];
          adc_a_q_dat <= adc_a_q_sum[15+14:14];
          adc_b_q_dat <= adc_b_q_sum[15+14:14];
        end
        32'h8000: begin
          adc_a_dat   <= adc_a_sum[15+15:15];
          adc_b_dat   <= adc_b_sum[15+15:15];
          adc_a_q_dat <= adc_a_q_sum[15+15:15];
          adc_b_q_dat <= adc_b_q_sum[15+15:15];
        end
        32'h10000: begin
          adc_a_dat   <= adc_a_sum[15+16:16];
          adc_b_dat   <= adc_b_sum[15+16:16];
          adc_a_q_dat <= adc_a_q_sum[15+16:16];
          adc_b_q_dat <= adc_b_q_sum[15+16:16];
        end

        32'h20000: begin
          adc_a_dat   <= adc_a_sum[15+17 : 17];
          adc_b_dat   <= adc_b_sum[15+17 : 17];
          adc_a_q_dat <= adc_a_q_sum[15+17 : 17];
          adc_b_q_dat <= adc_b_q_sum[15+17 : 17];
        end
        32'h40000: begin
          adc_a_dat   <= adc_a_sum[15+18 : 18];
          adc_b_dat   <= adc_b_sum[15+18 : 18];
          adc_a_q_dat <= adc_a_q_sum[15+18 : 18];
          adc_b_q_dat <= adc_b_q_sum[15+18 : 18];
        end
        32'h80000: begin
          adc_a_dat   <= adc_a_sum[15+19 : 19];
          adc_b_dat   <= adc_b_sum[15+19 : 19];
          adc_a_q_dat <= adc_a_q_sum[15+19 : 19];
          adc_b_q_dat <= adc_b_q_sum[15+19 : 19];
        end
        32'h100000: begin
          adc_a_dat   <= adc_a_sum[15+20 : 20];
          adc_b_dat   <= adc_b_sum[15+20 : 20];
          adc_a_q_dat <= adc_a_q_sum[15+20 : 20];
          adc_b_q_dat <= adc_b_q_sum[15+20 : 20];
        end
        32'h200000: begin
          adc_a_dat   <= adc_a_sum[15+21 : 21];
          adc_b_dat   <= adc_b_sum[15+21 : 21];
          adc_a_q_dat <= adc_a_q_sum[15+21 : 21];
          adc_b_q_dat <= adc_b_q_sum[15+21 : 21];
        end
        32'h400000: begin
          adc_a_dat   <= adc_a_sum[15+22 : 22];
          adc_b_dat   <= adc_b_sum[15+22 : 22];
          adc_a_q_dat <= adc_a_q_sum[15+22 : 22];
          adc_b_q_dat <= adc_b_q_sum[15+22 : 22];
        end
        32'h800000: begin
          adc_a_dat   <= adc_a_sum[15+23 : 23];
          adc_b_dat   <= adc_b_sum[15+23 : 23];
          adc_a_q_dat <= adc_a_q_sum[15+23 : 23];
          adc_b_q_dat <= adc_b_q_sum[15+23 : 23];
        end
        32'h1000000: begin
          adc_a_dat   <= adc_a_sum[15+24 : 24];
          adc_b_dat   <= adc_b_sum[15+24 : 24];
          adc_a_q_dat <= adc_a_q_sum[15+24 : 24];
          adc_b_q_dat <= adc_b_q_sum[15+24 : 24];
        end
        32'h2000000: begin
          adc_a_dat   <= adc_a_sum[15+25 : 25];
          adc_b_dat   <= adc_b_sum[15+25 : 25];
          adc_a_q_dat <= adc_a_q_sum[15+25 : 25];
          adc_b_q_dat <= adc_b_q_sum[15+25 : 25];
        end
        32'h4000000: begin
          adc_a_dat   <= adc_a_sum[15+26:26];
          adc_b_dat   <= adc_b_sum[15+26:26];
          adc_a_q_dat <= adc_a_q_sum[15+26:26];
          adc_b_q_dat <= adc_b_q_sum[15+26:26];
        end
        32'h8000000: begin
          adc_a_dat   <= adc_a_sum[15+27:27];
          adc_b_dat   <= adc_b_sum[15+27:27];
          adc_a_q_dat <= adc_a_q_sum[15+27:27];
          adc_b_q_dat <= adc_b_q_sum[15+27:27];
        end
        32'h10000000: begin
          adc_a_dat   <= adc_a_sum[15+28:28];
          adc_b_dat   <= adc_b_sum[15+28:28];
          adc_a_q_dat <= adc_a_q_sum[15+28:28];
          adc_b_q_dat <= adc_b_q_sum[15+28:28];
        end
        32'h20000000: begin
          adc_a_dat   <= adc_a_sum[15+29:29];
          adc_b_dat   <= adc_b_sum[15+29:29];
          adc_a_q_dat <= adc_a_q_sum[15+29:29];
          adc_b_q_dat <= adc_b_q_sum[15+29:29];
        end
        32'h40000000: begin
          adc_a_dat   <= adc_a_sum[15+30:30];
          adc_b_dat   <= adc_b_sum[15+30:30];
          adc_a_q_dat <= adc_a_q_sum[15+30:30];
          adc_b_q_dat <= adc_b_q_sum[15+30:30];
        end
        32'h80000000: begin
          adc_a_dat   <= adc_a_sum[15+31:31];
          adc_b_dat   <= adc_b_sum[15+31:31];
          adc_a_q_dat <= adc_a_q_sum[15+31:31];
          adc_b_q_dat <= adc_b_q_sum[15+31:31];
        end
        default: begin
          adc_a_dat   <= adc_a_sum[15+0 : 0];
          adc_b_dat   <= adc_b_sum[15+0 : 0];
  ...
  always @(posedge adc_clk_i) begin
    if (adc_rstn_i == 1'b0) begin
      ...
      if (adc_arm_do) adc_we <= 1'b1;
      else if (((adc_dly_do || adc_trig) && (adc_dly_cnt == 32'h0)) || adc_rst_do) //delayed reached or reset
        adc_we <= 1'b0;


      if (adc_rst_do) adc_wp <= {RSZ{1'b0}};
      else if (adc_we && adc_dv) adc_wp <= adc_wp + 1'b1;

      if (adc_rst_do) adc_wp_trig <= {RSZ{1'b0}};
      else if (adc_trig && !adc_dly_do)
        adc_wp_trig <= adc_wp_cur;  // save write pointer at trigger arrival

      if (adc_rst_do) adc_wp_cur <= {RSZ{1'b0}};
      else if (adc_we && adc_dv) adc_wp_cur <= adc_wp;  // save current write pointer


      if (adc_trig) adc_dly_do <= 1'b1;
      else if ((adc_dly_do && (adc_dly_cnt == 32'b0)) || adc_rst_do || adc_arm_do) //delayed reached or reset
        adc_dly_do <= 1'b0;

      if (adc_dly_do && adc_we && adc_dv) adc_dly_cnt <= adc_dly_cnt + {32{1'b1}};  // -1
      else if (!adc_dly_do) adc_dly_cnt <= set_dly;
  ...
  // Read
  always @(posedge adc_clk_i) begin
    if (adc_rstn_i == 1'b0) adc_rval <= 4'h0;
    else adc_rval <= {adc_rval[2:0], (ren || wen)};
  end
  ...
  always @(posedge adc_clk_i) begin
    if (adc_rstn_i == 1'b0) begin
      ...
      if (wen && (addr[19:0] == 20'h4)) set_trig_src <= wdata[3:0];
      else if (((adc_dly_do || adc_trig) && (adc_dly_cnt == 32'h0)) || adc_rst_do) //delayed reached or reset
        set_trig_src <= 4'h0;
  ...
  always @(posedge adc_clk_i) begin
    if (adc_rstn_i == 1'b0) begin
      ...
      if (adc_dv) begin
        ...
        else if ($signed(adc_a_dat) < $signed(set_a_treshm))
          adc_scht_ap[0] <= 1'b0;  // wait until it goes under hysteresis
        if ($signed(adc_a_dat) <= $signed(set_a_tresh)) adc_scht_an[0] <= 1'b1;  // treshold reached
        else if ($signed(adc_a_dat) > $signed(set_a_treshp))
          adc_scht_an[0] <= 1'b0;  // wait until it goes over hysteresis
  ...
  always @(posedge adc_clk_i) begin
    if (adc_rstn_i == 1'b0) begin
      ...
      else if (ext_trig_debp != 20'h0) ext_trig_debp <= ext_trig_debp - 20'd1;

      if ((ext_trig_debn == 20'h0) && (!ext_trig_in[1] && ext_trig_in[2]))
        ext_trig_debn <= 20'd62500;  // ~0.5ms
      else if (ext_trig_debn != 20'h0) ext_trig_debn <= ext_trig_debn - 20'd1;

      // update output values
      ext_trig_dp[1] <= ext_trig_dp[0];
      if (ext_trig_debp == 20'h0) ext_trig_dp[0] <= ext_trig_in[1];

      ext_trig_dn[1] <= ext_trig_dn[0];
      if (ext_trig_debn == 20'h0) ext_trig_dn[0] <= ext_trig_in[1];
      ...
      else if (asg_trig_debp != 20'h0) asg_trig_debp <= asg_trig_debp - 20'd1;

      if ((asg_trig_debn == 20'h0) && (!asg_trig_in[1] && asg_trig_in[2]))
        asg_trig_debn <= 20'd62500;  // ~0.5ms
      else if (asg_trig_debn != 20'h0) asg_trig_debn <= asg_trig_debn - 20'd1;

      // update output values
      asg_trig_dp[1] <= asg_trig_dp[0];
      if (asg_trig_debp == 20'h0) asg_trig_dp[0] <= asg_trig_in[1];

      asg_trig_dn[1] <= asg_trig_dn[0];
      if (asg_trig_debn == 20'h0) asg_trig_dn[0] <= asg_trig_in[1];
    end
  end
  ...
  always @(*) begin
    ...
    casez (addr[19:0])
      20'h00004: begin
        ack   <= 1'b1;
        rdata <= {{32 - 4{1'b0}}, set_trig_src};
      end

      20'h00008: begin
        ack   <= 1'b1;
        rdata <= {{32 - 14{1'b0}}, set_a_tresh};
      end
      20'h0000C: begin
        ack   <= 1'b1;
        rdata <= {{32 - 14{1'b0}}, set_b_tresh};
      end
      20'h00010: begin
        ack   <= 1'b1;
        rdata <= {set_dly};
      ...
      20'h00014: begin
        ack   <= 1'b1;
        rdata <= {{32 - 32{1'b0}}, set_dec};
      end

      20'h00018: begin
        ack   <= 1'b1;
        rdata <= {{32 - RSZ{1'b0}}, adc_wp_cur};
      end
      20'h0001C: begin
        ack   <= 1'b1;
        rdata <= {{32 - RSZ{1'b0}}, adc_wp_trig};
      end

      20'h00020: begin
        ack   <= 1'b1;
        rdata <= {{32 - 14{1'b0}}, set_a_hyst};
      end
      20'h00024: begin
        ack   <= 1'b1;
        rdata <= {{32 - 14{1'b0}}, set_b_hyst};
      end

      20'h00028: begin
        ack   <= 1'b1;
        rdata <= {{32 - 1{1'b0}}, set_avg_en};
      end

      20'h00030: begin
        ack   <= 1'b1;
        rdata <= {{32 - 18{1'b0}}, set_a_filt_aa};
      end
      20'h00034: begin
        ack   <= 1'b1;
        rdata <= {{32 - 25{1'b0}}, set_a_filt_bb};
      end
      20'h00038: begin
        ack   <= 1'b1;
        rdata <= {{32 - 25{1'b0}}, set_a_filt_kk};
      end
      20'h0003C: begin
        ack   <= 1'b1;
        rdata <= {{32 - 25{1'b0}}, set_a_filt_pp};
      end
      20'h00040: begin
        ack   <= 1'b1;
        rdata <= {{32 - 18{1'b0}}, set_b_filt_aa};
      end
      20'h00044: begin
        ack   <= 1'b1;
        rdata <= {{32 - 25{1'b0}}, set_b_filt_bb};
      end
      20'h00048: begin
        ack   <= 1'b1;
        rdata <= {{32 - 25{1'b0}}, set_b_filt_kk};
      end
      20'h0004C: begin
        ack   <= 1'b1;
        rdata <= {{32 - 25{1'b0}}, set_b_filt_pp};
      end

      20'h1????: begin
        ack   <= adc_rd_dv;
        rdata <= {2'h0, adc_b_rd, 2'h0, adc_a_rd};
      end
      20'h2????: begin
        ack   <= adc_rd_dv;
        rdata <= {2'h0, adc_b_q_rd, 2'h0, adc_a_q_rd};
      end
