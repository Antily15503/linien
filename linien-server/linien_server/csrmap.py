...
csr = {
    ...
    'logic_sequence_sinusoid_en_active': (8, 0x056, 2, True),
    'logic_sequence_saved_pid_out': (8, 0x057, 14, False),
    'logic_sequence_saved_integrator': (8, 0x059, 25, False),
    'logic_sequence_saved_sweep_pos': (8, 0x05d, 14, False),
    'logic_sequence_saved_dac_out': (8, 0x05f, 14, False),
    'logic_sequence_fsm_reg_addr': (8, 0x061, 9, True),
    'logic_sequence_fsm_reg_data': (8, 0x063, 32, True),
    'logic_sequence_fsm_reg_wen': (8, 0x067, 1, True),
    'logic_sequence_awg_reg_addr': (8, 0x068, 10, True),
    'logic_sequence_awg_reg_data': (8, 0x06a, 14, True),
    'logic_sequence_awg_reg_wen': (8, 0x06c, 1, True),
    'logic_sequence_num_blocks_1': (8, 0x06d, 4, True),
    'logic_sequence_num_blocks_2': (8, 0x06e, 4, True),
    'logic_sequence_num_blocks_3': (8, 0x06f, 4, True),
    'logic_sequence_num_blocks_4': (8, 0x070, 4, True),
    'logic_sequence_init_v': (8, 0x071, 14, True),
    'logic_raw_acquisition_iir_z0': (8, 0x073, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x077, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x07b, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x07f, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x083, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x087, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x08b, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x08f, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x093, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x097, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x09b, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x09f, 25, True),
    'logic_control_signal_clr': (8, 0x0a3, 1, True),
    'logic_control_signal_max': (8, 0x0a4, 25, False),
    'logic_control_signal_min': (8, 0x0a8, 25, False),
    'logic_combined_error_signal_clr': (8, 0x0ac, 1, True),
    'logic_combined_error_signal_max': (8, 0x0ad, 25, False),
    'logic_combined_error_signal_min': (8, 0x0b1, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x0b5, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x0b6, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x0ba, 25, False),
