...
csr = {
    ...
    'logic_autolock_robust_N_instructions': (8, 0x048, 3, True),
    ...
    'logic_autolock_robust_wait_for_0': (8, 0x06b, 14, True),
    'logic_autolock_robust_wait_for_1': (8, 0x06d, 14, True),
    'logic_autolock_robust_wait_for_2': (8, 0x06f, 14, True),
    'logic_autolock_robust_wait_for_3': (8, 0x071, 14, True),
    'logic_autolock_robust_wait_for_4': (8, 0x073, 14, True),
    'logic_autolock_robust_wait_for_5': (8, 0x075, 14, True),
    'logic_autolock_robust_wait_for_6': (8, 0x077, 14, True),
    'logic_autolock_robust_wait_for_7': (8, 0x079, 14, True),
    'logic_autolock_fast_target_position': (8, 0x07b, 14, True),
    'logic_autolock_request_lock': (8, 0x07d, 1, True),
    'logic_autolock_autolock_mode': (8, 0x07e, 2, True),
    'logic_autolock_lock_running': (8, 0x07f, 1, False),
    'logic_sequence_reset_seq': (8, 0x080, 1, True),
    'logic_sequence_arm': (8, 0x081, 4, True),
    'logic_sequence_status_1': (8, 0x082, 2, False),
    'logic_sequence_status_2': (8, 0x083, 2, False),
    'logic_sequence_status_3': (8, 0x084, 2, False),
    'logic_sequence_status_4': (8, 0x085, 2, False),
    'logic_sequence_sinusoid_reg_addr': (8, 0x086, 4, True),
    'logic_sequence_sinusoid_reg_data': (8, 0x087, 32, True),
    'logic_sequence_sinusoid_en': (8, 0x08b, 1, True),
    'logic_sequence_sinusoid_active': (8, 0x08c, 1, True),
    'logic_sequence_saved_pid_out': (8, 0x08d, 14, False),
    'logic_sequence_saved_integrator': (8, 0x08f, 25, False),
    'logic_sequence_saved_sweep_pos': (8, 0x093, 14, False),
    'logic_sequence_saved_dac_out': (8, 0x095, 14, False),
    'logic_sequence_fsm_reg_addr': (8, 0x097, 9, True),
    'logic_sequence_fsm_reg_data': (8, 0x099, 32, True),
    'logic_sequence_fsm_reg_wen': (8, 0x09d, 1, True),
    'logic_sequence_awg_reg_addr': (8, 0x09e, 10, True),
    'logic_sequence_awg_reg_data': (8, 0x0a0, 14, True),
    'logic_sequence_awg_reg_wen': (8, 0x0a2, 1, True),
    'logic_sequence_num_blocks_1': (8, 0x0a3, 4, True),
    'logic_sequence_num_blocks_2': (8, 0x0a4, 4, True),
    'logic_sequence_num_blocks_3': (8, 0x0a5, 4, True),
    'logic_sequence_num_blocks_4': (8, 0x0a6, 4, True),
    'logic_sequence_init_v': (8, 0x0a7, 14, True),
    'logic_raw_acquisition_iir_z0': (8, 0x0a9, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x0ad, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x0b1, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x0b5, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x0b9, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x0bd, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x0c1, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x0c5, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x0c9, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x0cd, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x0d1, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x0d5, 25, True),
    'logic_control_signal_clr': (8, 0x0d9, 1, True),
    'logic_control_signal_max': (8, 0x0da, 25, False),
    'logic_control_signal_min': (8, 0x0de, 25, False),
    'logic_combined_error_signal_clr': (8, 0x0e2, 1, True),
    'logic_combined_error_signal_max': (8, 0x0e3, 25, False),
    'logic_combined_error_signal_min': (8, 0x0e7, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x0eb, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x0ec, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x0f0, 25, False),
    ...
    'temp_control_duty': (10, 0x000, 12, True),
    'temp_control_sample_data': (10, 0x002, 18, False),
    'temp_control_sample_count': (10, 0x005, 8, False),
