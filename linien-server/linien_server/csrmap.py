...
csr = {
    ...
    'logic_sequence_saved_pid_out': (8, 0x051, 14, False),
    'logic_sequence_saved_integrator': (8, 0x053, 25, False),
    'logic_sequence_saved_sweep_pos': (8, 0x057, 14, False),
    'logic_sequence_saved_dac_out': (8, 0x059, 14, False),
    'logic_sequence_fsm_reg_addr': (8, 0x05b, 9, True),
    'logic_sequence_fsm_reg_data': (8, 0x05d, 32, True),
    'logic_sequence_fsm_reg_wen': (8, 0x061, 1, True),
    'logic_sequence_awg_reg_addr': (8, 0x062, 10, True),
    'logic_sequence_awg_reg_data': (8, 0x064, 14, True),
    'logic_sequence_awg_reg_wen': (8, 0x066, 1, True),
    'logic_sequence_num_blocks_1': (8, 0x067, 4, True),
    'logic_sequence_num_blocks_2': (8, 0x068, 4, True),
    'logic_sequence_num_blocks_3': (8, 0x069, 4, True),
    'logic_sequence_num_blocks_4': (8, 0x06a, 4, True),
    'logic_sequence_init_v': (8, 0x06b, 14, True),
    'logic_raw_acquisition_iir_z0': (8, 0x06d, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x071, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x075, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x079, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x07d, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x081, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x085, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x089, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x08d, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x091, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x095, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x099, 25, True),
    'logic_control_signal_clr': (8, 0x09d, 1, True),
    'logic_control_signal_max': (8, 0x09e, 25, False),
    'logic_control_signal_min': (8, 0x0a2, 25, False),
    'logic_combined_error_signal_clr': (8, 0x0a6, 1, True),
    'logic_combined_error_signal_max': (8, 0x0a7, 25, False),
    'logic_combined_error_signal_min': (8, 0x0ab, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x0af, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x0b0, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x0b4, 25, False),
