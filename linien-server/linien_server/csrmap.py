...
csr = {
    ...
    'logic_sequence_reset_seq': (8, 0x04b, 1, True),
    'logic_sequence_arm': (8, 0x04c, 4, True),
    'logic_sequence_status_1': (8, 0x04d, 2, False),
    'logic_sequence_status_2': (8, 0x04e, 2, False),
    'logic_sequence_status_3': (8, 0x04f, 2, False),
    'logic_sequence_status_4': (8, 0x050, 2, False),
    'logic_sequence_sinusoid_reg_addr': (8, 0x051, 4, True),
    'logic_sequence_sinusoid_reg_data': (8, 0x052, 32, True),
    'logic_sequence_sinusoid_en': (8, 0x056, 1, True),
    'logic_sequence_sinusoid_active': (8, 0x057, 1, True),
    'logic_sequence_saved_pid_out': (8, 0x058, 14, False),
    'logic_sequence_saved_integrator': (8, 0x05a, 25, False),
    'logic_sequence_saved_sweep_pos': (8, 0x05e, 14, False),
    'logic_sequence_saved_dac_out': (8, 0x060, 14, False),
    'logic_sequence_fsm_reg_addr': (8, 0x062, 9, True),
    'logic_sequence_fsm_reg_data': (8, 0x064, 32, True),
    'logic_sequence_fsm_reg_wen': (8, 0x068, 1, True),
    'logic_sequence_awg_reg_addr': (8, 0x069, 10, True),
    'logic_sequence_awg_reg_data': (8, 0x06b, 14, True),
    'logic_sequence_awg_reg_wen': (8, 0x06d, 1, True),
    'logic_sequence_num_blocks_1': (8, 0x06e, 4, True),
    'logic_sequence_num_blocks_2': (8, 0x06f, 4, True),
    'logic_sequence_num_blocks_3': (8, 0x070, 4, True),
    'logic_sequence_num_blocks_4': (8, 0x071, 4, True),
    'logic_sequence_init_v': (8, 0x072, 14, True),
    'logic_raw_acquisition_iir_z0': (8, 0x074, 27, True),
    'logic_raw_acquisition_iir_a1': (8, 0x078, 25, True),
    'logic_raw_acquisition_iir_a2': (8, 0x07c, 25, True),
    'logic_raw_acquisition_iir_a3': (8, 0x080, 25, True),
    'logic_raw_acquisition_iir_a4': (8, 0x084, 25, True),
    'logic_raw_acquisition_iir_a5': (8, 0x088, 25, True),
    'logic_raw_acquisition_iir_b0': (8, 0x08c, 25, True),
    'logic_raw_acquisition_iir_b1': (8, 0x090, 25, True),
    'logic_raw_acquisition_iir_b2': (8, 0x094, 25, True),
    'logic_raw_acquisition_iir_b3': (8, 0x098, 25, True),
    'logic_raw_acquisition_iir_b4': (8, 0x09c, 25, True),
    'logic_raw_acquisition_iir_b5': (8, 0x0a0, 25, True),
    'logic_control_signal_clr': (8, 0x0a4, 1, True),
    'logic_control_signal_max': (8, 0x0a5, 25, False),
    'logic_control_signal_min': (8, 0x0a9, 25, False),
    'logic_combined_error_signal_clr': (8, 0x0ad, 1, True),
    'logic_combined_error_signal_max': (8, 0x0ae, 25, False),
    'logic_combined_error_signal_min': (8, 0x0b2, 25, False),
    'logic_combined_error_signal_filtered_clr': (8, 0x0b6, 1, True),
    'logic_combined_error_signal_filtered_max': (8, 0x0b7, 25, False),
    'logic_combined_error_signal_filtered_min': (8, 0x0bb, 25, False),
